...
for d in ("at01_common", "at20_market", "at30_analytics", "at50_strategy", "at50_execution", "at60_risk", "at70_backtest"):
    sys.path.insert(0, str(ROOT / d))

from at70_backtest.backtest_engine import BacktestConfig, run_backtest  # noqa: E402
